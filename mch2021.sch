...
F0 "LED" 39
F1 "led.sch" 39
F2 "DATA_IN" I R 3550 1450 50 
F3 "DATA_OUT" O R 3550 1550 50 
$EndSheet
$Comp
L power:GND #PWR02
U 1 1 5F329148
...
NoConn ~ 1600 2300
$Comp
L Simple_Addon_v2:Simple_Addon_v2 X?
U 1 1 5FB73F84
P 5800 6450
F 0 "X?" V 5335 6450 50  0000 C CNN
...
Wire Wire Line
	5850 6000 6500 6000
Text Notes 12250 300  0    79   ~ 0
To-do:\n - STM32 USB D+ pull-up via GPIO?\n - STM32 USB CC to GPIO?\n - STM32 RTC\n - I2S DAC\n
Wire Wire Line
	9150 1750 9150 2150
$Comp
L power:GND #PWR016
...
AR Path="/5FE8307E" Ref="R?"  Part="1" 
F 0 "R?" V 9150 900 50  0000 C CNN
...
AR Path="/5FE83088" Ref="R?"  Part="1" 
F 0 "R?" V 9050 900 50  0000 C CNN
...
F15 "SD_D0" B R 8600 1850 50 
F16 "SD_CLK" O R 8600 1650 50 
F17 "SD_CMD" O R 8600 1450 50 
F18 "IRQ_FPGA" I R 8600 2400 50 
F19 "SPI_CS_LCD" O L 6900 2050 50 
F20 "SPI_CS_STM32" O L 6900 1850 50 
F21 "SPI_CS_FPGA" O L 6900 1950 50 
$EndSheet
Wire Wire Line
	9200 850  9200 900 
Wire Wire Line
...
AR Path="/5FFB7CC1" Ref="R?"  Part="1" 
F 0 "R?" V 8850 900 50  0000 C CNN
...
AR Path="/5FFB7F4D" Ref="R?"  Part="1" 
F 0 "R?" V 8950 900 50  0000 C CNN
